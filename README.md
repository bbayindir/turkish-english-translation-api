...
This project is a simple API that fetches a word (**Bir Kelime**) from the TDK, translates it into English using Google Translator, and returns both the Turkish word and its English translation.
